...
public class MessageSenderViewHolder extends RecyclerView.ViewHolder {
    ...
    public MessageSenderViewHolder(View itemView) {
        super(itemView);
        this.textViewMessage = (TextView) itemView.findViewById(R.id.text_view_sender_body);
        this.textViewTime = (TextView) itemView.findViewById(R.id.text_view_sender_time);
    }
