...
public class RetrieveLiftAsDriverTask extends AsyncTask<Void, Void, Integer> {
    ...
    public RetrieveLiftAsDriverTask(RendezvousLiftTask taskExecutor) {
    ...
    protected Integer doInBackground(Void... voids) {
        ...
        try {
            this.lifts = this.liftDAO.findLift(userID, LiftType.OFFERED);
